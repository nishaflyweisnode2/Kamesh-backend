        ...
        feature: {
          safety: {
            ...
            emergencybrakelightflash:
              row["feature:safety:emergencybrakelightflash"],
          ...
          brakingTraction: {
            antiLockBrackingSystem:
              row["feature:brakingTraction:antiLockBrackingSystem"],
            electronicBrakeForceDistribution:
              row["feature:brakingTraction:electronicBrakeForceDistribution"],
            brakeassit: row["feature:brakingTraction:brakeassit"],
            electronicStability:
              row["feature:brakingTraction:electronicStability"],
          ...
          comfortConvenience: {
            ...
            electronicParking:
              row["feature:comfortConvenience:electronicParking"],
            ...
            twelvePowerOutlets:
              row["feature:comfortConvenience:twelvePowerOutlets"],
          },
          telematic: {
